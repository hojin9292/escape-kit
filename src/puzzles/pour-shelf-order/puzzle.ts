...
export const pourShelfOrder: PuzzleModule = {
  ...
  mount: (api) => mountRecapBoard(api, {
    ...
    cards: [
      { id: "water-pour", asset: "tool-water-pour", name: "물 따르기", recap: "컵의 안전선까지" },
      { id: "ice-drop", asset: "tool-ice-drop", name: "얼음 주문", recap: "주문표의 두세 개" },
      { id: "jam-spread", asset: "tool-jam-spread", name: "잼 바르기", recap: "빵이 비치게 얇고 고르게" },
      { id: "yogurt-topping", asset: "tool-yogurt-topping", name: "요거트 주문", recap: "토핑 한 숟가락" },
    ],
  }),
};
