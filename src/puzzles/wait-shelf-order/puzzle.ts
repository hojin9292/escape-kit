...
export const waitShelfOrder: PuzzleModule = {
  ...
  mount: (api) => mountRecapBoard(api, {
    ...
    cards: [
      { id: "microwave-wait", asset: "tool-microwave-wait", name: "전자레인지", recap: "알림이 울릴 때까지" },
      { id: "homework-check", asset: "tool-homework-check", name: "숙제 확인", recap: "이름과 빠진 칸 확인" },
      { id: "crosswalk-signal", asset: "tool-crosswalk-signal", name: "횡단보도", recap: "초록불을 확인하고" },
      { id: "friend-turn-wait", asset: "tool-friend-turn-wait", name: "친구 차례", recap: "문장이 끝나고 나를 볼 때" },
    ],
  }),
};
