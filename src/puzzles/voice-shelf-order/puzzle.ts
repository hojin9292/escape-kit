...
export const voiceShelfOrder: PuzzleModule = {
  ...
  mount: (api) => mountRecapBoard(api, {
    ...
    cards: [
      { id: "voice-volume", asset: "tool-voice-volume", name: "도서관 목소리", recap: "바로 옆 친구에게 작게" },
      { id: "call-name", asset: "tool-call-name", name: "이름 부르기", recap: "한두 번 부르고 기다리기" },
      { id: "wait-answer", asset: "tool-wait-answer", name: "대답 기다리기", recap: "상대가 나를 보면 듣기" },
      { id: "story-turn", asset: "tool-story-turn", name: "차례 지키기", recap: "말하고 들어 주기" },
    ],
  }),
};
