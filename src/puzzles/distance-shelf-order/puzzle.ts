...
export const distanceShelfOrder: PuzzleModule = {
  ...
  mount: (api) => mountRecapBoard(api, {
    ...
    cards: [
      { id: "elevator-distance", asset: "tool-elevator-distance", name: "엘리베이터 거리", recap: "서로 편한 간격" },
      { id: "shoulder-tap", asset: "tool-shoulder-tap", name: "좁은 길 부탁하기", recap: "먼저 말하고 기다리기" },
      { id: "approach-friend", asset: "tool-approach-friend", name: "친구에게 다가가기", recap: "시야를 가리지 않는 거리" },
      { id: "bag-space", asset: "tool-bag-space", name: "버스 가방 자리", recap: "자리와 통로 비우기" },
    ],
  }),
};
