...
목소리 진열대 코너 [sealed shelf-corner, opensWhen: 4개 code:*-solved 전부]
  ─ 최종 콘솔 voice-shelf-order(복습 보드, gate 없음) → door:communication-open → 출구
```
...
| 최종 voice-shelf-order | CO-003·007·008·014 | 활동 카드 확인(순서 없음) | 네 장 모두 확인 | `door:communication-open` |
